...
/**
 * Class SessionProspectSearchFormPersister.
 *
 * @DI\Service("kgc.elastic.prospect.session.form_persister")
 */
class SessionProspectSearchFormPersister implements ProspectSearchFormPersisterInterface
{
    /**
     * @var LoggerInterface
     */

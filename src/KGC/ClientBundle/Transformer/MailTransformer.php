...
/**
 * @DI\Service("kgc.client.mail.transformer")
 */
class MailTransformer
{
     ...
     * @return Mail
     */
    public function transform($baseUrl, Mail $mail, $rdvId)
    {
        $html = $mail->getHtml();
        $text = $mail->getText();
     ...
     * @return Mail
     */
    public function transformChat($baseUrl, Mail $mail, $clientId)
    {
        $html = $mail->getHtml();
        $text = $mail->getText();
